...
Feature: Orange HRM login page
  ...
  Scenario: Login with valid credentials
    ...
    Then admin is directed to the homepage with the message "You logged into a secure area!"

  Scenario: Login with invalid credentials
    When admin enters an incorrect username "ichraf" and correct password "admin123"
    Then admin remains on the login page with the error message "Your username is invalid!"
